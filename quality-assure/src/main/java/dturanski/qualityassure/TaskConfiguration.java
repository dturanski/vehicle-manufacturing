...
public class TaskConfiguration {
    ...
    public CommandLineRunner commandLineRunner(EventPublisher eventPublisher) {
        ...
        return args -> {
            ...
            vehicle.getVehicleStatus().setInspectionPassed(result);

            log.info("Inspected vehicle vin {} result {}", vehicle.getVinNumber(),
                    vehicle.getVehicleStatus().isInspectionPassed()? "passed" : "failed");
