...
public class TaskConfiguration {
    ...
    public CommandLineRunner commandLineRunner(EventPublisher eventPublisher) {
        ...
        return args -> {
            ...
            AddTransmissionRequest addTransmissionRequest = objectMapper.readValue(json,AddTransmissionRequest.class);
            log.info("Transmission Added for vin {} specs {}", addTransmissionRequest);

            Event event = new Event();
            event.setType("transmissionAdded");
            event.setData(addTransmissionRequest);
