...
public class QualityAssureApplicationTests {
    ...
    public void test() {
        ...
        vehicle.setVehicleStatus(new VehicleStatus());
        ...
        new ApplicationContextRunner().withUserConfiguration(
                ...
                .run(context -> {
                    ...
                    commandLineRunner.run("request=" + objectMapper.writeValueAsString(vehicle),
                            "maxSleepMs=0");
                    ...
                    Vehicle inspected = objectMapper.convertValue(event.getData(),Vehicle.class);
                    vehicle.getVehicleStatus().setInspectionPassed(inspected.getVehicleStatus().isInspectionPassed());
                    assertThat(vehicle).isEqualTo(inspected);
