...
public class AddTrimApplicationTests {
    private ObjectMapper objectMapper = new ObjectMapper();

    @Test
    public void test() {
        AddTrimRequest addTrimRequest = new AddTrimRequest("123", "LX", "red");
        ...
        new ApplicationContextRunner().withUserConfiguration(
                ...
                .run(context -> {
                    ...
                    commandLineRunner.run("request=" + objectMapper.writeValueAsString(addTrimRequest),
                            "maxSleepMs=0");
                    ...
                    assertThat(objectMapper.convertValue(event.getData(), AddTrimRequest.class))
                            .isEqualTo(addTrimRequest);
                });
    }
