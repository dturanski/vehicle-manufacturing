...
public class TaskConfiguration {
    ...
    public CommandLineRunner commandLineRunner(EventPublisher eventPublisher) {
        ...
        return args -> {
            ...
            AddEngineRequest addEngineRequest = objectMapper.readValue(json,AddEngineRequest.class);
            log.info("Engine Added for vin {} specs {}", addEngineRequest);

            Event event = new Event();
            event.setType("engineAdded");
            event.setData(addEngineRequest);
